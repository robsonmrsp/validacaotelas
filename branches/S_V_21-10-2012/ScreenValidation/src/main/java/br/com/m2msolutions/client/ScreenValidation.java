...
public class ScreenValidation implements EntryPoint {
	...
	public void onModuleLoad() {
		...
		dockDesktop.getBottomDock().addItem(Images.INSTANCE.calendar128().getURL(), "Calendario");
		dockDesktop.getBottomDock().addItem(Images.INSTANCE.link128().getURL(), "Links");
		dockDesktop.getBottomDock().addItem(Images.INSTANCE.alert128().getURL(), "Eventos");
		dockDesktop.getBottomDock().addItem(Images.INSTANCE.rss128().getURL(), "Rss");
		dockDesktop.getBottomDock().addItem(Images.INSTANCE.calendar128().getURL(), "Calendario");
		dockDesktop.getBottomDock().addItem(Images.INSTANCE.alert128().getURL(), "Eventos");
		dockDesktop.getBottomDock().addItem(Images.INSTANCE.link128().getURL(), "Links");
		dockDesktop.getBottomDock().addItem(Images.INSTANCE.rss128().getURL(), "Rss");
