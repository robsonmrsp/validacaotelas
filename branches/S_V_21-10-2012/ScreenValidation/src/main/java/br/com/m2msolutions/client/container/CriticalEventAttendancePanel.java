...
public class CriticalEventAttendancePanel extends LayoutContainer {
	...
	public CriticalEventAttendancePanel() {
		...
		cpHeaderCenter.add(getBtnNewButton(), new AbsoluteData(294, 70));
		cpHeaderCenter.add(getBtnResolvido(), new AbsoluteData(294, 88));
	...
	private Button getBtnResolvido() {
		if (btnResolvido == null) {
			...
			btnResolvido.setSize("60px", "20px");
		}
		return btnResolvido;
	}
